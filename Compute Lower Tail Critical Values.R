...
sims <- 5
###ub should be probability associated with the critical value (e.g. for an lower tailed test with alpha = 0.05, ub = 0.05)
ub = 0.05
...
for(i in 1:sims){
  global.TS.00[i] <- min((OTS.00.TS[i,]-mean.00)/sd.00)
  global.TS.01[i] <- min((OTS.01.TS[i,]-mean.01)/sd.01)
  global.TS.02[i] <- min((OTS.02.TS[i,]-mean.02)/sd.02)
  global.TS.03[i] <- min((OTS.03.TS[i,]-mean.03)/sd.03)
  #global.TS.04[i] <- min((OTS.04.TS[i,]-mean.04)/sd.04)
  
  global.TS.10[i] <- min((OTS.10.TS[i,]-mean.10)/sd.10)
  global.TS.11[i] <- min((OTS.11.TS[i,]-mean.11)/sd.11)
  global.TS.12[i] <- min((OTS.12.TS[i,]-mean.12)/sd.12)
  global.TS.13[i] <- min((OTS.13.TS[i,]-mean.13)/sd.13)
  #global.TS.14[i] <- min((OTS.14.TS[i,]-mean.14)/sd.14)
  
  global.TS.20[i] <- min((OTS.20.TS[i,]-mean.20)/sd.20)
  global.TS.21[i] <- min((OTS.21.TS[i,]-mean.21)/sd.21)
  global.TS.22[i] <- min((OTS.22.TS[i,]-mean.22)/sd.22)
  global.TS.23[i] <- min((OTS.23.TS[i,]-mean.23)/sd.23)
  #global.TS.24[i] <- min((OTS.24.TS[i,]-mean.24)/sd.24)
  
  global.TS.30[i] <- min((OTS.30.TS[i,]-mean.30)/sd.30)
  global.TS.31[i] <- min((OTS.31.TS[i,]-mean.31)/sd.31)
  global.TS.32[i] <- min((OTS.32.TS[i,]-mean.32)/sd.32)
  global.TS.33[i] <- min((OTS.33.TS[i,]-mean.33)/sd.33)
  #global.TS.34[i] <- min((OTS.34.TS[i,]-mean.34)/sd.34)
  
  #global.TS.40[i] <- min((OTS.40.TS[i,]-mean.40)/sd.40)
  #global.TS.41[i] <- min((OTS.41.TS[i,]-mean.41)/sd.41)
  #global.TS.42[i] <- min((OTS.42.TS[i,]-mean.42)/sd.42)
  #global.TS.43[i] <- min((OTS.43.TS[i,]-mean.43)/sd.43)
  #global.TS.44[i] <- min((OTS.44.TS[i,]-mean.44)/sd.44)
}

global.TS <- rep(NA,sims)
for(i in 1:sims){
  ###Use this for 4 categories
  global.TS[i] = min(c((OTS.00.TS[i,]-mean.00)/sd.00,(OTS.01.TS[i,]-mean.01)/sd.01,(OTS.02.TS[i,]-mean.02)/sd.02,(OTS.03.TS[i,]-mean.03)/sd.03,
  ...
  #global.TS[i] = min(c((OTS.00.TS[i,]-mean.00)/sd.00,(OTS.01.TS[i,]-mean.01)/sd.01,(OTS.02.TS[i,]-mean.02)/sd.02,(OTS.03.TS[i,]-mean.03)/sd.03,(OTS.04.TS[i,]-mean.04)/sd.04,
...
#UB.ij is an n.rad dimensional vector containing the critical value for the test statistic detecting dispersion of category j surrounding category i at each individual radius
...
#results is a K by K matrix with entry in row i and column j equal to the critical value for the global test over all radii of the test statistic testing for dispersion of category j surrounding category i
